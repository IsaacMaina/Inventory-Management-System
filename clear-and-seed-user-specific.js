...
// Use the DATABASE_URL from environment - this ensures we connect to Neon
...
async function clearAndSeedUserData(userId) {
  try {
    ...
    for (const table of tablesToClear) {
      ...
      console.log(`Cleared data from ${table} for user ${userId}`);
    }
    ...
    console.log(`📊 Created: ${Object.keys(categoryIds).length} categories, ${suppliers.length} suppliers, ${sampleProducts.length} products`);
