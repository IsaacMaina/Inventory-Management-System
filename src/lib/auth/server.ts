...
// This will be called from contexts where user data is passed down
...
export async function canAccessResource(
  ...
  try {
    ...
    if (resourceOwnerId) {
      ...
      if (isOwner(resourceOwnerId, userContext.id)) {
        return hasPermission(userContext, Permission.PRODUCT_READ); // Require at least read permission
      }
    }
